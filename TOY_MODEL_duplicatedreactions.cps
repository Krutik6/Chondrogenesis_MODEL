...
<!-- generated with COPASI 4.29 (Build 228) (http://www.copasi.org) at 2020-09-02T10:29:44Z -->
...
<dcterms:created>
<rdf:Description>
<dcterms:W3CDTF>2020-09-02T10:29:34Z</dcterms:W3CDTF>
</rdf:Description>
</dcterms:created>
</rdf:Description>
</rdf:RDF>
        ...
        <ModelParameterGroup cn="String=Kinetic Parameters" type="Group">
          <ModelParameterGroup cn="CN=Root,Model=New Model,Vector=Reactions[miRNA.Input.TF]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=New Model,Vector=Reactions[miRNA.Input.TF],ParameterGroup=Parameters,Parameter=V" value="3.5214799999999999" type="ReactionParameter" simulationType="fixed"/>
            <ModelParameter cn="CN=Root,Model=New Model,Vector=Reactions[miRNA.Input.TF],ParameterGroup=Parameters,Parameter=Shalve" value="6.4780699999999998" type="ReactionParameter" simulationType="fixed"/>
          ...
          <ModelParameterGroup cn="CN=Root,Model=New Model,Vector=Reactions[miRNA.Output]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=New Model,Vector=Reactions[miRNA.Output],ParameterGroup=Parameters,Parameter=k1" value="0.371639" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
          ...
          <ModelParameterGroup cn="CN=Root,Model=New Model,Vector=Reactions[Gene.Output]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=New Model,Vector=Reactions[Gene.Output],ParameterGroup=Parameters,Parameter=k1" value="9.2838399999999996" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
          <ModelParameterGroup cn="CN=Root,Model=New Model,Vector=Reactions[Gene.Output.miRNA]" type="Reaction">
            <ModelParameter cn="CN=Root,Model=New Model,Vector=Reactions[Gene.Output.miRNA],ParameterGroup=Parameters,Parameter=V" value="0.33913100000000002" type="ReactionParameter" simulationType="fixed"/>
            <ModelParameter cn="CN=Root,Model=New Model,Vector=Reactions[Gene.Output.miRNA],ParameterGroup=Parameters,Parameter=Km" value="95.624300000000005" type="ReactionParameter" simulationType="fixed"/>
            <ModelParameter cn="CN=Root,Model=New Model,Vector=Reactions[Gene.Output.miRNA],ParameterGroup=Parameters,Parameter=Ki" value="2.1142400000000001" type="ReactionParameter" simulationType="fixed"/>
          </ModelParameterGroup>
        </ModelParameterGroup>
      </ModelParameterSet>
...
<dcterms:created>
<rdf:Description>
<dcterms:W3CDTF>2020-09-02T10:29:28Z</dcterms:W3CDTF>
</rdf:Description>
</dcterms:created>
</rdf:Description>
</rdf:RDF>
